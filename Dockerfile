...
# SPDX-FileCopyrightText: 2026 The updater-maven Authors
...
LABEL org.opencontainers.image.title="semrel-plugin-updater-maven" \
      org.opencontainers.image.description="semrel plugin: updater-maven" \
      org.opencontainers.image.url="https://semrel.io" \
      org.opencontainers.image.source="https://github.com/SemRels/updater-maven" \
